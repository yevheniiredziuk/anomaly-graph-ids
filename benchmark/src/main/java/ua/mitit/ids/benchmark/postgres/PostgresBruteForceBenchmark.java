...
/** Section 6.4 — PostgreSQL "правило brute force (aggregate)". */
...
public class PostgresBruteForceBenchmark {

  private static final String QUERY = "SELECT * FROM detect_brute_force(?, ?, 100, 0.7)";

  @Benchmark
  public int bruteForce(InfrastructureState infra, WindowSampler sampler) throws Exception {
